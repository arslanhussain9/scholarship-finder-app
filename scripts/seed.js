...
const scholarshipsData = [
  ...
  },
  {
    ...
    eligible_classes: ["12th", "UG"],
    eligible_categories: ["All"],
    eligible_gender: "All",
    income_limit: 1500000,
    states: ["All"],
    description: "A merit-cum-means scholarship aimed at empowering meritorious students from all over India to continue their higher education.",
    benefits: "Up to ₹2,00,000 over the duration of the degree.",
    documents_required: ["Aadhar Card", "10th & 12th Marksheet", "Income Certificate", "Admission Proof"],
    deadline: new Date("2025-10-31"),
    apply_link: "https://www.scholarships.reliancefoundation.org/UG_Scholarship.aspx",
    status: "approved",
    source: "manual"
  },
  {
    name: "HDFC Bank Parivartan's ECSS Scholarship 2025-26",
    type: "Private",
    scholarship_level: "UG",
    eligible_classes: ["Class 1-12", "Diploma", "ITI", "UG", "PG"],
    eligible_categories: ["All"],
    eligible_gender: "All",
    income_limit: 250000,
    states: ["All"],
    description: "Supports meritorious and needy students belonging to underprivileged sections of society.",
    benefits: "Up to ₹75,000 depending on the course level.",
    documents_required: ["Aadhar Card", "Marksheet", "Income Certificate", "Admission Proof"],
    deadline: new Date("2025-09-30"),
    apply_link: "https://www.parivartanecss.com/",
    status: "approved",
    source: "manual"
  },
  {
    name: "SBI Asha Scholarship Program 2025-26",
    type: "Private",
    scholarship_level: "UG",
    eligible_classes: ["9th", "10th", "11th", "12th", "UG", "PG", "Medical", "IIT", "IIM"],
    eligible_categories: ["All"],
    eligible_gender: "All",
    income_limit: 600000,
    states: ["All"],
    description: "Financial assistance for meritorious students from low-income families, with 50% reservation for female candidates.",
    benefits: "₹15,000 to ₹5,00,000 depending on level.",
    documents_required: ["Aadhar Card", "Marksheet", "Income Certificate", "Admission Proof"],
    deadline: new Date("2025-10-15"),
    apply_link: "https://www.sbiashascholarship.co.in/",
    status: "approved",
    source: "manual"
  },
  {
    name: "Kotak Kanya Scholarship 2025-26",
    type: "Private",
    scholarship_level: "UG",
    eligible_classes: ["Engineering", "MBBS", "Law", "UG"],
    eligible_categories: ["All"],
    eligible_gender: "Female",
    income_limit: 360000,
    states: ["All"],
    description: "Aimed at supporting girl students from underprivileged backgrounds to pursue professional higher education.",
    benefits: "₹1.5 Lakh per year until completion of professional course/degree.",
    documents_required: ["Aadhar Card", "12th Marksheet", "Income Certificate", "Admission Proof"],
  ...
  {
    name: "LIC HFL Vidyadhan Scholarship 2025-26",
    type: "Private",
    scholarship_level: "UG",
    ...
    income_limit: 360000,
    states: ["All"],
    description: "Focuses on supporting students from economically weaker sections to continue their education.",
    benefits: "₹10,000 (School), ₹20,000 (UG), and ₹25,000 (PG) per year.",
    documents_required: ["Aadhar Card", "Marksheet", "Income Certificate", "Admission Proof"],
    deadline: new Date("2025-12-31"),
    apply_link: "https://lichfl.scholarsbox.in/",
    status: "approved",
    source: "manual"
  },
  {
    ...
    type: "Private",
    scholarship_level: "UG",
    eligible_classes: ["6th", "7th", "8th", "9th", "10th", "11th", "12th", "UG"],
    eligible_categories: ["All"],
    eligible_gender: "All",
    income_limit: 400000,
    states: ["All"],
    description: "Aims to provide financial support to students from economically disadvantaged backgrounds.",
    benefits: "Reimburses 80% of tuition fees, ranging from ₹10,000 to ₹50,000.",
    documents_required: ["Aadhar Card", "Marksheet", "Income Certificate", "Admission Proof"],
    deadline: new Date("2025-10-25"),
    apply_link: "https://www.buddy4study.com/page/the-tata-capital-pankh-scholarship-programme",
    status: "approved",
    source: "manual"
  },
  {
    name: "Mahindra All India Talent Scholarship (MAITS) 2025-26",
    type: "Private",
    scholarship_level: "UG",
    eligible_classes: ["Diploma", "Polytechnic"],
    eligible_categories: ["All"],
    eligible_gender: "All",
    income_limit: 200000,
    states: ["All"],
    description: "Encourages students from low-income families to pursue technical/diploma education.",
    benefits: "₹10,000 per annum for a duration of 3 years.",
    documents_required: ["Aadhar Card", "10th Marksheet", "Income Certificate", "Admission Proof"],
    deadline: new Date("2025-08-31"),
    apply_link: "https://www.kcmet.org/what-we-do-scholarship-grants.aspx",
    status: "approved",
    source: "manual"
  },
  {
    name: "L'Oréal India For Young Women in Science Scholarship 2025-26",
    type: "Private",
    scholarship_level: "UG",
    eligible_classes: ["12th", "BSc", "Science"],
    eligible_categories: ["All"],
    eligible_gender: "Female",
    income_limit: 600000,
    states: ["All"],
    description: "Empowers young women to pursue careers in science and research.",
    benefits: "Up to ₹2.5 Lakh for the duration of the graduation course.",
    documents_required: ["Aadhar Card", "12th Marksheet", "Income Certificate", "Admission Proof"],
    deadline: new Date("2025-10-15"),
    apply_link: "https://www.foryoungwomeninscience.co.in/",
    status: "approved",
    source: "manual"
  },
  {
    name: "Santoor Scholarship Program 2025-26",
    type: "Private",
    scholarship_level: "UG",
    eligible_classes: ["UG"],
    eligible_categories: ["All"],
    ...
    description: "Supports young women from rural and backward areas in pursuing higher education.",
    benefits: "₹30,000 per annum until the completion of the degree.",
    documents_required: ["Aadhar Card", "Marksheet", "Income Certificate", "Admission Proof"],
    deadline: new Date("2025-09-30"),
    apply_link: "https://www.santoorscholarships.com/",
    status: "approved",
    source: "manual"
  },
